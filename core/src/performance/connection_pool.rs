...
impl ServiceConnectionManager {
    pub fn new(max_connections_per_service: usize) -> Self {
        Self {
            ...
            zquic_pool: ConnectionPool::new(max_connections_per_service),
        }
    }
    ...
    pub async fn get_zquic_connection(&self, endpoint: &str) -> Result<ConnectionHandle> {
        self.zquic_pool.get_connection(endpoint).await
    }
