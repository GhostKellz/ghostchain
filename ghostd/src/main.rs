...
//
// High-performance blockchain daemon with ZQUIC transport integration
// Features:
...
use ghostchain_shared::{
    types::*,
    ffi::zquic::ZQuicConfig,
    ffi::ghostbridge::GhostBridgeConfig,
};

mod config;
mod daemon;
mod api;
mod zquic_integration;
...
#[command(
    name = "ghostd",
    version = "0.1.0",
    about = "GhostChain blockchain daemon with ZQUIC integration",
